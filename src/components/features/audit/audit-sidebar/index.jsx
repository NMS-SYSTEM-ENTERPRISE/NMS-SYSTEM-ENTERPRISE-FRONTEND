...
import { AUDIT_NAV_ICON_CLASS, AUDIT_SIDEBAR_ITEMS } from '@/utils/constants/audit';

export const AuditSidebar = () => {
  const { isSidebarOpen, setIsSidebarOpen, activeView, setActiveView } = useAudit();
    ...
    >
      ...
      <nav className={sharedStyles.sidebarNav}>
        <div className={sharedStyles.treeRoot}>
          <Icon icon="mdi:security" className={sharedStyles.rootIcon} width={18} />
              ...
              >
                ...
                <div
                  className={clsx(
                    ...
                    !isActive && sharedStyles[AUDIT_NAV_ICON_CLASS[item.colorToken]]
                  )}
                >
