...
export const LogManagementSkeleton = () => {
  return (
               ...
               <div className={styles.tableSkeleton}>
                  ...
                  {[1, 2, 3, 4, 5].map((j) => (
                     <div key={j} className={styles.tableRowSkeleton}>
                        ...
                        <div className={`${styles.skeletonInner} ${styles.tableCell}`} style={{ width: '15%' }} />
                        <div className={`${styles.skeletonInner} ${styles.tableCell}`} style={{ width: '20%' }} />
                        <div className={`${styles.skeletonInner} ${styles.tableCell}`} style={{ width: '20%' }} />
                        <div className={`${styles.skeletonInner} ${styles.tableCell}`} style={{ width: '30%' }} />
                     </div>
                  ))}
               </div>
            </div>
