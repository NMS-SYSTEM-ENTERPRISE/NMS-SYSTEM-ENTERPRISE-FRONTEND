    ...
    <div className={styles.realtimeGrid}>
      <div className={styles.metricWidget}>
        <div className={styles.statHeader}>
          <div className={styles.statValue} style={{ color: '#ef4444' }}>15</div>
        </div>
      ...
      <div className={styles.metricWidget}>
        <div className={styles.statHeader}>
          <div className={styles.statValue} style={{ color: '#f97316' }}>3</div>
        </div>
      ...
      <div className={styles.metricWidget}>
        <div className={styles.statHeader}>
          <div className={styles.statValue} style={{ color: '#06b6d4' }}>24</div>
        </div>
      ...
      <div className={styles.metricWidget}>
        <div className={styles.statHeader}>
          <div className={styles.statValue} style={{ color: '#22d3ee' }}>12</div>
        </div>
      ...
      <div className={styles.metricWidget}>
        <div className={styles.statHeader}>
          <div className={styles.statValue} style={{ color: '#a855f7' }}>2</div>
        </div>
    ...
    if (statusDistRef.current) {
      ...
      chart.setOption({
        ...
        series: [{
          ...
          itemStyle: { borderRadius: 6, borderColor: '#0b0f19', borderWidth: 3 },
          ...
          data: [
            ...
            { value: 12, name: 'In Progress', itemStyle: { color: '#eab308' } },
    ...
    <div className={styles.distributionGrid}>
      <div className={styles.distributionCard}>
        ...
        <div className={styles.chartFlex}>
          <div ref={statusDistRef} style={{ width: '140px', height: '140px' }} />
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '11px', color: '#9ca3af' }}>
              <span style={{ width: '8px', height: '8px', background: '#06b6d4', borderRadius: '2px' }} /> Open <span style={{ color: '#fff', marginLeft: 'auto', fontWeight: 'bold' }}>24</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '11px', color: '#9ca3af' }}>
              <span style={{ width: '8px', height: '8px', background: '#eab308', borderRadius: '2px' }} /> Progress <span style={{ color: '#fff', marginLeft: 'auto', fontWeight: 'bold' }}>12</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '11px', color: '#9ca3af' }}>
              <span style={{ width: '8px', height: '8px', background: '#10b981', borderRadius: '2px' }} /> Resolved <span style={{ color: '#fff', marginLeft: 'auto', fontWeight: 'bold' }}>8</span>
            </div>
          </div>
        </div>
      </div>
...
export const TicketingTables = () => {
  return (
    <div className={styles.tablesRow} style={{ marginTop: '0', border: 'none' }}>
        ...
        <table className={styles.miniTable}>
          ...
          <tbody>
            <tr>
              ...
              <td>darshan</td>
              <td><span className={`${styles.statusBadge} ${styles.statusOpen}`}>Open</span></td>
            </tr>
            <tr>
              <td>SR-3262 Leave/Time Off Re...</td>
              <td>darshan</td>
        ...
        <table className={styles.miniTable}>
          ...
          <tbody>
            <tr>
              ...
              <td>SR-3071</td>
              <td><span className={`${styles.statusBadge} ${styles.statusOpen}`}>Open</span></td>
              <td><span className={`${styles.statusBadge} ${styles.priorityLow}`}>Low</span></td>
            </tr>
            <tr>
              <td>TA-980 Admin - Docu...</td>
              <td>SR-3071</td>
              <td><span className={`${styles.statusBadge} ${styles.statusOpen}`}>Open</span></td>
              <td><span className={`${styles.statusBadge} ${styles.priorityHigh}`}>High</span></td>
            </tr>
          </tbody>
        </table>
      </div>
