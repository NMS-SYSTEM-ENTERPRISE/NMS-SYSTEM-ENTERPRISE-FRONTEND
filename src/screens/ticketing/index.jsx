...
const Ticketing = () => {
  ...
  const [expandedSections, setExpandedSections] = useState(new Set(['stats', 'analytics', 'list']));
      ...
      <div className={`${styles.leftSidebar} ${!isSidebarOpen ? styles.sidebarCollapsed : ''}`}>
        ...
        <nav className={styles.sidebarNav}>
          <div className={styles.treeRoot}>
            <Icon icon="mdi:ticket-confirmation-outline" className={styles.rootIcon} />
              ...
              >
                ...
                <div className={styles.itemIconWrapper}>
                  <Icon
                    ...
                    width={18}
                    style={{ 
                      color: activeCategory === item.id ? 'inherit' : item.color 
                    }}
                  />
                </div>
        ...
        <div className={styles.header}>
          <div className={styles.headerLeft}>
            <div className={styles.headerIcon}>
              <Icon 
                icon={SIDEBAR_ITEMS.find(i => i.id === activeCategory)?.icon || 'mdi:ticket'} 
                width={20} 
              />
            </div>
            <h1 className={styles.headerTitle}>
              {SIDEBAR_ITEMS.find(i => i.id === activeCategory)?.label || 'Tickets'}
            </h1>
          </div>
          ...
          <div className={styles.timelineContainer}>
            ...
            <div className={styles.accordionGroup} data-open={expandedSections.has('stats')}>
              <div className={styles.accordionHeader} onClick={() => toggleSection('stats')}>
                ...
                <div className={styles.headerInfo}>
                  <h3 className={styles.sectionTitle}>Real-time Analytics <span className={styles.badge} data-type="dashboard">Live</span></h3>
                </div>
                <Icon icon="mdi:chevron-down" className={styles.accordionChevron} width={20} />
              </div>
            ...
            <div className={styles.accordionGroup} data-open={expandedSections.has('analytics')}>
              <div className={styles.accordionHeader} onClick={() => toggleSection('analytics')}>
                ...
                <div className={styles.headerInfo}>
                  <h3 className={styles.sectionTitle}>Traffic Distribution <span className={styles.badge} style={{ color: '#c084fc', background: 'rgba(192, 132, 252, 0.1)' }}>Analytics</span></h3>
                </div>
                <Icon icon="mdi:chevron-down" className={styles.accordionChevron} width={20} />
              </div>
              <div className={styles.accordionContent}>
            ...
            <div className={styles.accordionGroup} data-open={expandedSections.has('list')}>
              <div className={styles.accordionHeader} onClick={() => toggleSection('list')}>
                <div className={styles.headerNode}>
                  <Icon icon="mdi:format-list-bulleted" width={18} />
                </div>
                <div className={styles.headerInfo}>
                  <h3 className={styles.sectionTitle}>Top Conversations <span className={styles.badge} data-type="list">Summary</span></h3>
                </div>
                <Icon icon="mdi:chevron-down" className={styles.accordionChevron} width={20} />
              </div>
              <div className={styles.accordionContent} style={{ padding: 0 }}>
                 <TicketingRequests 
                   ...
                   onTicketClick={(ticket) => handleOpenSidebar('details', ticket)} 
                 />
              </div>
            </div>
